...
namespace MC.EntradaService.ServiceImplementations
{
    ...
    public class EntradaService : ServiceBase, IEntradaService
    {
        ...
        public getValidarPlacaEntrada_Response getValidarPlacaEntrada(getValidarPlacaEntrada_Request request)
        {
            getValidarPlacaEntrada_Response response = new getValidarPlacaEntrada_Response();
            ...
            ResultadoOperacion oResultadoOperacion = _DataService.ValidarPlacaEntrada(request.sModulo);
            if (oResultadoOperacion.oEstado == TipoRespuesta.Exito)
            {
