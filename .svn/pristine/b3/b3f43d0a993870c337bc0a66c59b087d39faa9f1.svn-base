        ...
        private void tbPass_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)13)
            {
                if (tbUser.Text != string.Empty && tbPass.Text != string.Empty)
                {
                    ...
                    string strCadSQL1 = "SELECT Documento,Usuario,Clave, Estado,Cargo FROM  T_Usuarios WHERE  Usuario = '" + tbUser.Text + "' AND CLAVE = '" + tbPass.Text + "'";
                    ...
                    if (Estado == "True")
                    {
                        frmCobroCascos oPrincipal = new frmCobroCascos(User, Cargo);
