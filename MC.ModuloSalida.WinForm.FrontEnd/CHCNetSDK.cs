    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public struct NET_VCA_INTRUSION
        {
            ...
            /*
            ¼ì²âÄ¿±ê£¬¿ÉÖ§³Ö¶àÑ¡£¬¾ßÌå¶¨ÒåÎª£º
            0~ËùÓÐÄ¿±ê£¨±íÊ¾²»Ëø¶¨¼ì²âÄ¿±ê£¬ËùÓÐÄ¿±ê¶¼½«½øÐÐ¼ì²â£©
            0x01 ~ ÈË£¬
            0x02 ~ ³µ£¬
            */
            public byte byDetectionTarget;
            public byte byPriority;//ÓÅÏÈ¼¶, 0-µÍ, 1-ÖÐ, 2-¸ß
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        **********************************************************/
        [DllImport(@"C:\ENTRADA2\Config Library\HCNetSDK.dll")]
        ...
        **********************************************************/
        ...
        [DllImportAttribute(@"C:\ENTRADA2\Config Library\HCNetSDK.dll")]
